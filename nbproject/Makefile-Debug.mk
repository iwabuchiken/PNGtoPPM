...
${OBJECTDIR}/png_opaque.o: png_opaque.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/png_opaque.o png_opaque.c
...
${OBJECTDIR}/utils/img_lib.o: utils/img_lib.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/img_lib.o utils/img_lib.c

${OBJECTDIR}/utils/pgmlib.o: utils/pgmlib.c 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/pgmlib.o utils/pgmlib.c

${OBJECTDIR}/utils/ppmlib.o: utils/ppmlib.c 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/ppmlib.o utils/ppmlib.c
